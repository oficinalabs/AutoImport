// olxpt/watch.mjs — recolha CONTÍNUA (polling) do olx.pt. Mesma lógica do autohero/autoboerse: poll de
// X em X tempo, deteta NOVOS e MUDANÇAS DE PREÇO, mantém uma "tabela" de estado (id→linha) e emite
// eventos para o sink (DB isolada em lib/sink.mjs).
//
...
import { parseListingPage, listingUrl, recordId, ORDER_RECENTE } from './parse.mjs';
