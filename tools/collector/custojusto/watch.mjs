// custojusto/watch.mjs — recolha CONTÍNUA (polling) do CustoJusto.pt. Mesma lógica do
// autoboerse/watch.mjs: poll de X em X tempo, deteta NOVOS e MUDANÇAS DE PREÇO, mantém uma "tabela"
...
export async function watch(config) {
  ...
  while (!stop) {
    ...
    let vistos = 0, novos = 0, alterados = 0, maxTime = null;
