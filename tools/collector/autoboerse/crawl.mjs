// autoboerse/crawl.mjs — recolha batch do autoboerse.de: paginação, dedupe, checkpoint,
// NDJSON. Mesma forma do autotrader/crawl.mjs.
//
...
export async function crawl(config) {
  ...
  if (full) {
    ...
    queries = brands
      ...
      .map((b) => ({ label: b.text, brand: b.text }));
