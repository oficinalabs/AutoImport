// flexicar/crawl.mjs — recolha batch do flexicar.es: fatiamento por faceta, dedupe, checkpoint, NDJSON.
...
import { parseListingPage, extractBrandSlugs, extractSitemapFacets, recordId } from './parse.mjs';

const temNext = (t) => t.includes('__NEXT_DATA__');
const brandPath = (slug) => `/${slug}/segunda-mano/`;
