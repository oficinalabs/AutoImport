// carplus/watch.mjs — recolha CONTÍNUA (polling) do carplus.pt. Mesma lógica do autopt/autocasion:
...
const temPayload = (t) => t.includes('__NUXT_DATA__');
...
export async function watch(config) {
  ...
  while (!stop) {
    ...
    let vistos = 0, novos = 0, alterados = 0, maxUpd = null;
