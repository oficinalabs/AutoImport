// autoline/http.mjs — cliente HTTP do autoline.pt (wrapper fino do lib/http.mjs com o baseUrl
...
// isso NUNCA emitimos URLs com `?sort=` (a ordenação por data está fora; ver watch.mjs). Sem
