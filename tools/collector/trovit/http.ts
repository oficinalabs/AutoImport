// trovit/http.ts — cliente HTTP do Trovit (wrapper fino do lib/http.ts com o baseUrl e a
...
// do thribee). Consequência: `source` (site de origem) fica null; ver schema.ts.
//
