// caetano/schema.mjs — schema-alvo comum + mapeamento de uma viatura da API `search/v2` da Caetano
...
// lib/normalize.mjs), para comparar preços PT vs. UE de forma uniforme. A API devolve, por viatura,
...
//
// FILTRO (ver parse.mjs): a pesquisa de usados devolve maioritariamente `condition='Usado'` mas
