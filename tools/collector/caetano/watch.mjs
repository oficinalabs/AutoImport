// caetano/watch.mjs — recolha CONTÍNUA (polling) da Caetano. Mesma lógica do autohero/autopt: poll
// de X em X tempo, deteta NOVOS e MUDANÇAS DE PREÇO, mantém uma "tabela" de estado (id→linha) e
// emite eventos para o sink (DB isolada em lib/sink.mjs).
//
...
import { parseSearchResponse, recordId, PAGE_SIZE, SORT_RECENTE } from './parse.mjs';
