// encontracarros/schema.mjs — schema-alvo comum + mapeamento do detalhe do encontracarros.pt.
//
// PORQUÊ: todos os coletores da AutoImport produzem o MESMO registo normalizado (ver
// lib/normalize.mjs), para comparar preços PT vs. UE de forma uniforme. O encontracarros.pt é um
...
export function normalizeListing(raw, { collectedAt = null } = {}) {
  const veh = raw.veh || {};
  const offer = veh.offers || {};
