// encontracarros/sitemap.ts — enumeração dos anúncios a partir do sitemap.xml.
//
...
// Entrada do sitemap: URL do anúncio + id/lastmod/brandSlug derivados.
...
function brandSlugFromUrl(url: string | null): string | null {
...
export async function fetchSitemap(http: HttpClient): Promise<SitemapEntry[]> {
...
export function districtSlugFromUrl(url: string | null): string | null {
