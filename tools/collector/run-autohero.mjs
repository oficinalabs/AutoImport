// run-autohero.mjs — CLI da recolha batch do autohero.com (API GraphQL do grupo AUTO1).
//
// Uso:
//   node run-autohero.mjs --max-pages 3                 # amostra (3 páginas API × 100 = 300)
//   node run-autohero.mjs --full --max-pages 100        # catálogo completo (~75 páginas no DE)
//   node run-autohero.mjs --sort most_popular           # ordena por popularidade em vez de recência
...
import { crawl } from './autohero/crawl.mjs';
import { SORT_RECENTE } from './autohero/parse.mjs';
