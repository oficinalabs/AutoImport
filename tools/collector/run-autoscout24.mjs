// run-autoscout24.mjs — CLI da recolha batch do AutoScout24 (HTTP puro, pan-europeu).
//
...
//
// Uso:
//   node run-autoscout24.mjs --make bmw --max-pages 3          # amostra 1 marca (~300 anúncios, size=100)
//   node run-autoscout24.mjs --country D,A,B,E,F,I,L,NL --make bmw --max-pages 1   # pan-EU
//   node run-autoscout24.mjs --full                            # cobertura pan-EU (país×marca×preço)
//   node run-autoscout24.mjs --full --country D --make bmw --max-pages 2  # fatia + sub-fatia preço
//   node run-autoscout24.mjs --detail --make bmw --max-pages 1 # enriquece (1 req/anúncio)
//   node run-autoscout24.mjs --resume
//
...
import { crawl, PAN_EU } from './autoscout24/crawl.mjs';
