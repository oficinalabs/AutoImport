// run-autoboerse.mjs — CLI da recolha batch do autoboerse.de.
//
// Uso:
//   node run-autoboerse.mjs --max-pages 3                    # amostra (listagem geral)
...
import { crawl } from './autoboerse/crawl.mjs';
