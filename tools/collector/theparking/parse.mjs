// parse.mjs — extração dos dados de uma página de listagem do theparking.eu.
//
...
function idDoUrl(url) {
  const m = /([A-Z0-9]{6,})\.html/i.exec(url || '');
  return m ? m[1] : null;
}
...
export function extractCardSources(html) {
  const map = new Map();
...
export function readNbResults(html) {
