// quoka/parse.mjs — extração dos dados de uma página de listagem do quoka.de.
//
...
export function extractLdMap(html) {
  const map = new Map();
...
function parsePreco(chunk) {
  const digits = (s) => { const d = (s || '').replace(/[^\d]/g, ''); return d ? Number(d) : null; };
