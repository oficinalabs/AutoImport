// santogal/crawl.mjs — recolha batch do santogal.pt: paginação, dedupe, checkpoint, NDJSON, stats.
// Mesma forma do autopt/crawl.mjs (dedupe global por id, checkpoint/resume, stats).
//
...
function urlListagem(make, page) {
...
const temCards = (t) => t.includes('card_car');
