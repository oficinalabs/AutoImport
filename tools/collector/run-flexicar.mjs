// run-flexicar.mjs — CLI da recolha batch do flexicar.es.
//
// Uso:
//   node run-flexicar.mjs --max-pages 3                 # amostra (base + fatias por marca)
//   node run-flexicar.mjs --brand audi --max-pages 1    # só uma marca (rota /audi/segunda-mano/)
//   node run-flexicar.mjs --full --max-pages 500        # cobertura fatiada por faceta (seed sitemap)
...
import { crawl } from './flexicar/crawl.mjs';
