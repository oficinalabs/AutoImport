// run-caetano.mjs — CLI da recolha batch da Caetano (rede de stands do Grupo Salvador Caetano;
// stock de usados/seminovos via a API "Digital Store" api.gsci.pt, companyId 24).
//
// Uso:
//   node run-caetano.mjs --max-pages 3            # amostra (3 páginas API × 250 viaturas)
//   node run-caetano.mjs --full --max-pages 30    # catálogo completo (~13 páginas)
...
import { crawl } from './caetano/crawl.mjs';
