// run-custojusto.mjs — CLI da recolha batch do CustoJusto.pt.
//
// Uso:
...
// o nº de facetas processadas por execução. Ver custojusto/crawl.mjs.
//
...
import { crawl } from './custojusto/crawl.mjs';
