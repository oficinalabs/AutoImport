// run-autotrader.mjs — CLI da recolha batch do AutoTrader.nl.
//
// Uso:
//   node run-autotrader.mjs --max-pages 3                 # amostra (lista default)
...
import { crawl } from './autotrader/crawl.mjs';
