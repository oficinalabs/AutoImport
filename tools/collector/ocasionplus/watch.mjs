// ocasionplus/watch.mjs — recolha CONTÍNUA (polling) do ocasionplus.com. Mesma lógica do
// autocasion/watch.mjs: poll de X em X tempo, deteta NOVOS e MUDANÇAS DE PREÇO, mantém uma "tabela"
...
export async function watch(config) {
  ...
  while (!stop) {
    ...
    let vistos = 0, novos = 0, alterados = 0, topo = null;
