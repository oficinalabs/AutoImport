// autotrader/watch.ts — recolha CONTÍNUA (polling) do AutoTrader.nl. Mesma lógica do
// theparking/watch.ts: poll de X em X tempo, deteta NOVOS e MUDANÇAS DE PREÇO, mantém uma
...
type WatchRow = AutotraderRecord & { first_seen: string; last_seen: string };
