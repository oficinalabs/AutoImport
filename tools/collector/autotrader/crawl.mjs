// autotrader/crawl.mjs — recolha batch do AutoTrader.nl: paginação, dedupe, checkpoint,
// NDJSON. Mesma forma do theparking/crawl.mjs.
//
...
function urlListagem(params, page) {
...
export async function crawl(config) {
  ...
  // --- plano de queries ---
  const baseParams = make ? { mmvmk0: String(make) } : {};
  let queries;
  if (full) {
