...
**Progresso:** 5/16 a recolher (secção 5a completa; falta 5b/5c/5d).
...
| Site | Tipo | Volume PT (aprox.) | Stands/Particulares | Notas técnicas (recolha) | Estado |
|---|---|---|---|---|---|
| [OParking](https://www.oparking.pt) | Agregador/meta-motor | ~128k indexados PT | Ambos (indexa stands + part.) | **Família theparking.eu** (front PT, irmão de leparking.fr/dasparking.de) → **já temos coletor** (`tools/collector/theparking/`): quick win, reaproveitar o molde. JS-heavy (`ctrl.switchSearch()`) mas **sem Cloudflare** | 🔴 Por fazer (quick win) |
| [AutoUncle.pt](https://www.autouncle.pt/pt/carros-usados) | Agregador/meta-motor | ~99k listagens PT (de ~9 fontes PT; "93 sites" é total global) | Ambos; verificação de concessionários | **SPA JS-heavy**; enriquece com avaliação de preço própria (AutoScore); apps nativas | 🔴 Por fazer |
| [encontracarros.pt](https://www.encontracarros.pt) | Agregador/meta-motor | grande (compara os principais sites PT; 800+ stands) | Sobretudo stands | **Server-side routing** (`/pesquisa`, `/estatisticas`, `/stands`), sem SPA/JS notado; tem ferramenta de estatística de preço (útil como sinal de mercado) | 🔴 Por fazer |
